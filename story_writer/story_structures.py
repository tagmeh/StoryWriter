...
def get_story_structure_schema(story_structure: StoryStructureEnum) -> dict:
    try:
...
def get_story_structure_model(story_structure: StoryStructureEnum) -> type[BaseModel]:
    try:
